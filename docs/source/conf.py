...
project = "quat2eul"  # pylint: disable=invalid-name
copyright = "2021, Pécheux"  # pylint: disable=redefined-builtin, invalid-name, line-too-long
author = "Clément Pécheux"  # pylint: disable=invalid-name
_project_path = pathlib.Path(__file__).parent.parent.parent
_version_path = _project_path / f"{project}/__version__.py"
...
html_theme_options = {
    ...
    "github_user": "ClemPech",
    "github_repo": "quaterniontoeuler",
    "github_button": True,
    "github_type": "star",
    "github_banner": True,
    "codecov_button": True,
